...
function variables() {
  ...
  if (el != null) {
    document.getElementById("deadline_task8").innerHTML = "16.11.2021";
  } else {
  }
  ...
  if (el != null) {
    document.getElementById("deadline_task9").innerHTML = "18.11.2021";
  } else {
  }
  ...
  if (el != null) {
    document.getElementById("deadline_task20").innerHTML = "7 days (until 25.01.22 at 23:59:59)";
  } else {
  }
